...
def preprocess_hero_stats(m_hero_df):
...
def get_hero_trends(): #Creates two data dfs, one for 7 day hero trends, one for 30 day hero trends.
    ...
    hero_trends_7d = preprocess_hero_stats(hero_trends_7d)
    hero_trends_30d = fetch_hero_stats(get_time_delta(30), min_average_badge)
    hero_trends_30d = preprocess_hero_stats(hero_trends_30d)
...
def main():
    ...
    raw_match_hero_data = fetch_hero_stats(min_unix_time, min_average_badge) #Returns Dataframe of hero data over x_days, above min_average_badge
    
    logging.info(f"match_hero data fetched.")
    logging.debug(f"raw_m_h_data has been received.")

    match_hero_stats = preprocess_hero_stats(raw_match_hero_data)
