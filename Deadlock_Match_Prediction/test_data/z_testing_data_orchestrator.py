...
from Deadlock_Match_Prediction.services.dl_process_data import filter_account_data, filter_match_data, filter_player_hero_data, split_players_and_matches, calculate_hero_stats, calculate_player_hero_stats
...
def orchestrate_active_match_data():
    ...
    print(f"\n******spliting data**** \n")
    match_data, account_data = split_players_and_matches(raw_match_data)
